            ...
            <div>
                    ...
                    <div className="container">
                        <Row className="ptb20">
                            ...
                            <Col md={4} className="p30 news-entry">
                                <a href="/blog">
                                    <div className="image" style={{ 'background':"url('https://s3-us-west-2.amazonaws.com/cosmicjs/60a9c670-2af6-11e7-ae54-e9a1fc58ec22-repetition-success-tech-uncensored.jpg') center/cover" }}></div>
                                    <div className="content text-center">
                                        <div className="title">REPETITION === SUCCESS</div>
                                        <div className="desc">Go read the Tech Uncensored blog. It's super awesome!</div>
                                    </div>
                                </a>
                            </Col>
                            <Col md={4} className="p30 news-entry">
                                <div className="image" style={{ 'background':"url('https://s3-us-west-2.amazonaws.com/cosmicjs/6a385e90-2af6-11e7-ae54-e9a1fc58ec22-npm-theres-a-package-for-that-tech-uncensored.jpg') center/cover" }}></div>
                                <div className="content text-center">
                                    <div className="title" >THERE'S A PACKAGE FOR THAT</div>
                                    <div className="desc">Go read the Tech Uncensored blog. It's super awesome!</div>
                                </div>
                            </Col>
                            <Col md={4} className="p30 news-entry">
                                <div className="image" style={{ 'background':"url('https://s3-us-west-2.amazonaws.com/cosmicjs/7156ba00-2af6-11e7-ae54-e9a1fc58ec22-three-qualities-of-a-software-engineer-tech-uncensored.jpg') center/cover" }}></div>
                                <div className="content text-center" >
                                    <div className="title">3 QUALITIES OF A SOFTWARE ENGINEER</div>
                                    <div className="desc">Go read the Tech Uncensored blog. It's super awesome!</div>
                                </div>
                            </Col>
                        </Row>
                    ...
                    <div id="newsletter" className="container-fluid callout ptb50">
                        <div className="container">
                            <Row className="text-center font-large">
                                <Col md={6} sm={12} className="text-right cta fwl ffr">
